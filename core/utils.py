...
# def compute_loss(y_true, y_pred, true_boxes, grid_h, grid_w, batch_size, anchors, class_weights, warm_up_batches=0):
    ...
    # loss = tf.Print(loss, [pred_box_conf], message="hello", summarize=1000)
    ...
    # return loss, loss_xy, loss_wh, loss_conf, loss_class, current_recall, total_recall, tf.constant(0.)
